...
.my-plant button:disabled {
    background-color: gray;
    cursor: not-allowed;
}

.my-plant button:hover:enabled {
    background-color: rgb(102, 187, 106);
}
...
.choose-plant button:hover {
    background-color: rgba(129, 199, 132, 0.3);
}

/* Formulaire enregistrer action */
.register-action {
    margin-top: 30px;
...
.register-action input[type="text"],
.register-action textarea {
...
/* Liste des membres, demandes, actions */
ul {
    list-style: none;
    padding: 0;
    margin: 0 auto;
...
/* Boutons quitter/supprimer */
.leave-button, .delete-group-button {
    display: block;
    margin: 20px auto;
    padding: 10px 20px;
    font-weight: bold;
